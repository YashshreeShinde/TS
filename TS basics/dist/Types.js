...
let num2 = 10;
function add(num1, num2, result, booleanValue) {
    if (booleanValue) {
        let res = num1 + num2;
...
let person1;
let favouriteActivities; //it can only consist strings
...
//----------------------------------------------------------------------------------------------------------------------
//Literal types:-
function combineAges(input1, input2, resultConversion //Literal type:-only these two strings are allowed
) {
    let result;
...
console.log(combineNames);
function combineAges1(input1, input2, resultConversion //Literal type:-only these two strings are allowed
) {
    let result;
    if (typeof input1 === 'number' && typeof input2 === 'number' || resultConversion === 'as-number') {
        result = +input1 + +input2;
